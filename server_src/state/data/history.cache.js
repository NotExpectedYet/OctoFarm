...
const serverSettingsCache = require("../../services/server-settings.service");
...
class HistoryCache {
  ...
  static getSpool(filamentSelection, job, success, time) {
    ...
    for (const key of Object.keys(job)) {
      ...
      const spoolName = HistoryCache.getSpoolLabel(filamentEntry);
      spools.push({
        [key]: {
